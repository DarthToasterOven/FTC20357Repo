...
public class MeepMeepTesting {
    public static void main(String[] args) {
        ...
        myFirstBot.runAction(myFirstBot.getDrive().actionBuilder(new Pose2d(-48, -50, Math.toRadians(233)))
...
//                .strafeTo(new Vector2d(35.25,-53))
                .build());
        mySecondBot.runAction(mySecondBot.getDrive().actionBuilder(new Pose2d(-48, 50, Math.toRadians(-233)))
                .strafeToLinearHeading(new Vector2d(-34,12),Math.toRadians(-235))
                .waitSeconds(2.5)
                .strafeToLinearHeading(new Vector2d(-11.5,28),Math.toRadians(-90))
                .strafeTo(new Vector2d(-11.5,53))
