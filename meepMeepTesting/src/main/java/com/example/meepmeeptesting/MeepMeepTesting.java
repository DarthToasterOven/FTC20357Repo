...
public class MeepMeepTesting {
    public static void main(String[] args) {
        ...
        myFirstBot.runAction(myFirstBot.getDrive().actionBuilder(new Pose2d(-48, -50, Math.toRadians(45)))
                ...
                .strafeToLinearHeading(new Vector2d(-16,-16), Math.toRadians(235))
                .waitSeconds(2.5)
                ...
                .build());
        mySecondBot.runAction(mySecondBot.getDrive().actionBuilder(new Pose2d(-48, 50, Math.toRadians(310)))
                .strafeToLinearHeading(new Vector2d(-16,4),Math.toRadians(140))
                .waitSeconds(2.5)
                .strafeToLinearHeading(new Vector2d(-11.5,28),Math.toRadians(270))
                .strafeTo(new Vector2d(-11.5,53))
